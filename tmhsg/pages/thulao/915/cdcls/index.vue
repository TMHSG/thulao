<template>
  <v-row>
    ...
    <v-col cols="12" sm="8" md="4" style="text-align: center; color:black"><h2>CHỈ ĐỊNH CẬN LÂM SÀN</h2></v-col>
    <v-col cols="12" sm="8" md="4"></v-col>
    <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    async getListNhanVien() {
      try {
        const response = await axios.get(`${this.apiUrl}/nhanvien915`);
