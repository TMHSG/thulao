...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Số phiếu', value: 'SoPhieuYeuCau' },
      { text: 'Ngày', value: 'Ngay' },
      { text: 'Loại bệnh án', value: 'LoaiBenhAn' },
      { text: 'Nhóm', value: 'NhomDichVu' },

      { text: 'Phí thu', value: 'PhiThu' },
  ...
  methods: {
    ...
    async exportToExcel() {
      const fileName = `915_TongHopDV_${this.formatDate(
        this.TuNgay
