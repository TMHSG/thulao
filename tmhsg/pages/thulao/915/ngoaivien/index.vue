...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Ngày', value: 'NgayKham' },
      { text: 'Công ty', value: 'CongTy' },
      { text: 'Tên mức giảm', value: 'LoaiHoso' },
      { text: 'Tên hợp đồng', value: 'TenHopDong' },
      { text: 'Nội dung khám', value: 'NoiDungKham' },
      { text: 'Tên bác sĩ', value: 'BacSi' },
      { text: 'Phạm vi khám', value: 'PhamViKham' },
      { text: 'Phạm vi', value: 'PhamVi' },
      { text: 'Nhóm', value: 'Nhom' },
      { text: 'Số lượng khám', value: 'SoLuongKham' },
  ...
  methods: {
    ...
    async exportToExcel() {
      const fileName = `915_KSKdalieungoaivien_${this.formatDate(
        this.TuNgay
