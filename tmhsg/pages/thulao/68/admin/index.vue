<template>
  <v-container>
    ...
    >
      ...
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Tỷ lệ thù lao 6-8</v-toolbar-title>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Khám bệnh (KL)', value: 'PhanTram_Kham_KL' },
      ...
      { text: 'Gây mê TMH (DB)', value: 'PhanTram_GM_DB' },
      { text: 'Gây mê TMH (BH)', value: 'PhanTram_GM_BH' },
      { text: 'Gây mê TMH (KL)', value: 'PhanTram_GM_KL' },
      ...
      { text: 'KSK 2 BS HD1', value: 'KSKCTyGC2_2BS_HD1' },
      { text: 'KSK 2 BS HD2', value: 'KSKCTyGC2_2BS_HD2' },
      { text: 'KSK 2 BS HD3', value: 'KSKCTyGC2_2BS_HD3' },
      { text: 'KSK 3 BS HD1', value: 'KSKCTyGC2_3BS_HD1' },
      { text: 'KSK 3 BS HD2', value: 'KSKCTyGC2_3BS_HD2' },
      { text: 'KSK 3 BS HD3', value: 'KSKCTyGC2_3BS_HD3' },
      { text: 'KSK 4 BS HD1', value: 'KSKCTyGC2_4BS_HD1' },
      { text: 'KSK 4 BS HD2', value: 'KSKCTyGC2_4BS_HD2' },
      { text: 'KSK 4 BS HD3', value: 'KSKCTyGC2_4BS_HD3' },
      { text: 'KSK dưới 4 CK HD1', value: 'KSKCTy_Duoi4CK_HD1' },
      { text: 'KSK dưới 4 CK HD2', value: 'KSKCTy_Duoi4CK_HD2' },
      { text: 'KSK dưới 4 CK HD3', value: 'KSKCTy_Duoi4CK_HD3' },
      { text: 'KSK phụ khoa KSK HD1', value: 'KSKCTy_PhuKhoaKSK_HD1' },
      { text: 'KSK phụ khoa KSK HD2', value: 'KSKCTy_PhuKhoaKSK_HD2' },
      { text: 'KSK phụ khoa KSK HD3', value: 'KSKCTy_PhuKhoaKSK_HD3' },
  ...
  methods: {
    ...
    return;
      ...
      try {
        const response=  await axios.post(`${this.apiUrl}/uploadExcel68`, formData, {
          headers: {
    ...
    async fetchDoctorName() {
      try {
        const response = await axios.get(
          `${this.apiUrl}/tennhanvien68/${this.addItems.NhanVien_Id}`
        )
    ...
    async getListbacsi() {
      try {
        const response = await axios.get(`${this.apiUrl}/tylethulao68`)
    ...
    async getListnhanvien() {
      try {
        const response = await axios.get(`${this.apiUrl}/listnhanvien68`)
    ...
    async saveEdit() {
      try {
        const response = await axios.put(
          `${this.apiUrl}/updatebacsi68/${this.editItems.NhanVien_Id}`,
          this.editItems,
          { validateStatus: false }
        )
  ...
  if (num !== null && num !== undefined) {
    ...
    async deleteItem() {
      try {
        ...
        const deleteResponse = await axios.delete(
          `${this.apiUrl}/xoabacsi68/${this.selectedNhanVienId}`
        )
    ...
    async sendLogToServer(actionType, data) {
      ...
      await axios.post(`${this.apiUrl}/insertlog68`, logEntry)
    },
    exportToExcel() {
      ...
      const columns = [
        ...
        {header: 'Gây mê TMH(DB)', key: 'PhanTram_GM_DB' },
        {header: 'Gây mê TMH(BH)', key: 'PhanTram_GM_BH' },
        {header: 'Gây mê TMH(KL)', key: 'PhanTram_GM_KL' },
        ...
        {header: 'CLSKSKDKHD3', key: 'PhanTram_CLSKSKDK_HD3' },
        {header: 'CLSKSKDKHD2', key: 'PhanTram_CLSKSKDK_HD2' },
        {header: 'CLSKSKDKHD1', key: 'PhanTram_CLSKSKDK_HD1' },
        ...
        {header: 'KSK 2 BS HD1', key: 'KSKCTyGC2_2BS_HD1' },
        {header: 'KSK 2 BS HD2', key: 'KSKCTyGC2_2BS_HD2' },
        {header: 'KSK 2 BS HD3', key: 'KSKCTyGC2_2BS_HD3' },
        {header: 'KSK 3 BS HD1', key: 'KSKCTyGC2_3BS_HD1' },
        {header: 'KSK 3 BS HD2', key: 'KSKCTyGC2_3BS_HD2' },
        {header: 'KSK 3 BS HD3', key: 'KSKCTyGC2_3BS_HD3' },
        {header: 'KSK 4 BS HD1', key: 'KSKCTyGC2_4BS_HD1' },
        {header: 'KSK 4 BS HD2', key: 'KSKCTyGC2_4BS_HD2' },
        {header: 'KSK 4 BS HD3', key: 'KSKCTyGC2_4BS_HD3' },
        {header: 'KSK dưới 4 CK HD1', key: 'KSKCTy_Duoi4CK_HD1' },
        {header: 'KSK dưới 4 CK HD2', key: 'KSKCTy_Duoi4CK_HD2' },
        {header: 'KSK dưới 4 CK HD3', key: 'KSKCTy_Duoi4CK_HD3' },
        {header: 'KSK phụ khoa KSK HD1', key: 'KSKCTy_PhuKhoaKSK_HD1' },
        {header: 'KSK phụ khoa KSK HD2', key: 'KSKCTy_PhuKhoaKSK_HD2' },
        {header: 'KSK phụ khoa KSK HD3', key: 'KSKCTy_PhuKhoaKSK_HD3' },
