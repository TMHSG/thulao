...
module.exports.__inject__ = function (context) {
  add("ff786108", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_cd58b6b8_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(281);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_cd58b6b8_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_cd58b6b8_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_cd58b6b8_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_cd58b6b8_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/benhvien/ngoaigio/index.vue?vue&type=template&id=cd58b6b8
...
var ngoaigiovue_type_template_id_cd58b6b8_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
  ...
  }, [_c('h2', [_vm._v("NGOÀI GIỜ")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "sm": "8",
      "md": "4"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(_vm.formatDateTime(item.NgayYeuCau)) + "\n      ")];
      }
    }, {
...
// CONCATENATED MODULE: ./pages/thulao/benhvien/ngoaigio/index.vue?vue&type=template&id=cd58b6b8
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/benhvien/ngoaigio/index.vue?vue&type=script&lang=js


/* harmony default export */ var ngoaigiovue_type_script_lang_js = ({
  name: 'ngoaigio',
  components: {},
  data: () => ({
    ngoaigio: [],
  ...
  computed: {
    ...
    tongThuLao() {
      // Tính tổng cột "ThuLao" dựa trên dữ liệu trong biến "ngoaigio"
      return this.ngoaigio.reduce((total, item) => {
  ...
  methods: {
    formatDateTime(dateTimeString) {
      ...
      const adjustedDateTime = new Date(originalDateTime.getTime() - 7 * 60 * 60 * 1000);
    ...
    async getData() {
      ...
      if (this.selectedNhanVien === null || this.selectedNhanVien === undefined) {
        url = `${this.apiUrl}/ngoaigio?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien}`;
        this.ngoaigio = await external_axios_default.a.get(url).then(function (response) {
        ...
        console.log('chay ok');
        url = `${this.apiUrl}/ngoaigio?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien.NhanVien_Id}`;
    ...
    async exportToExcel() {
      const fileName = `BV_ngoaigio_${this.formatDate(this.TuNgay)}_${this.formatDate(this.DenNgay)}.xlsx`;
      ...
      worksheet.addRow(['STT', 'Mã y tế', 'Tên bệnh nhân', 'Ngày khám', 'Tên dịch vụ', 'Nhóm', 'Bệnh án', 'Bác sĩ', 'Đơn giá', 'Thù lao']);
      const font = {
      ...
      // Thêm dữ liệu từ this.ngoaigio vào tệp Excel
      this.ngoaigio.forEach(item => {
        const NgayYeuCauDate = new Date(item.NgayYeuCau);
        const NgayYeuCauFormatted = this.formatDateTime(NgayYeuCauDate);
        // const NgayYeuCauFormatted = NgayYeuCauDate.toLocaleDateString('vi-VN', {
        //   year: 'numeric',
        //   month: '2-digit',
        //   day: '2-digit',
        //   hour: '2-digit',
        ...
        //   second: '2-digit',
        // })
        const row = worksheet.addRow([item.STT, item.MaYTe, item.TenBenhNhan, NgayYeuCauFormatted, item.TenDichVu, item.NhomDichVu, item.LoaiBenhAn, item.TenNhanVien, item.DonGiaThanhToan, item.ThuLao]);
        row.font = font;
      });
...
// CONCATENATED MODULE: ./pages/thulao/benhvien/ngoaigio/index.vue?vue&type=script&lang=js
 /* harmony default export */ var benhvien_ngoaigiovue_type_script_lang_js = (ngoaigiovue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(15);

// CONCATENATED MODULE: ./pages/thulao/benhvien/ngoaigio/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  benhvien_ngoaigiovue_type_script_lang_js,
  ngoaigiovue_type_template_id_cd58b6b8_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var ngoaigio = __webpack_exports__["default"] = (component.exports);
