...
module.exports.__inject__ = function (context) {
  add("129fd550", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_17746a7a_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(278);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_17746a7a_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_17746a7a_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_17746a7a_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_17746a7a_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/benhvien/dieutrinoitru/index.vue?vue&type=template&id=17746a7a
...
var dieutrinoitruvue_type_template_id_17746a7a_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
  ...
  }, [_c('h2', [_vm._v("ĐIỀU TRỊ NỘI TRÚ")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "sm": "8",
      "md": "4"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Date(item.NgayRaVien).toLocaleDateString("vi-VN", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit"
        })) + "\n      ")];
...
// CONCATENATED MODULE: ./pages/thulao/benhvien/dieutrinoitru/index.vue?vue&type=template&id=17746a7a
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/benhvien/dieutrinoitru/index.vue?vue&type=script&lang=js


/* harmony default export */ var dieutrinoitruvue_type_script_lang_js = ({
  name: "dieutrinoitru",
  components: {},
  data: () => ({
    dieutrinoitru: [],
  ...
  computed: {
    ...
    tongThuLao() {
      // Tính tổng cột "ThuLao" dựa trên dữ liệu trong biến "dieutrinoitru"
      return this.dieutrinoitru.reduce((total, item) => {
  ...
  methods: {
    ...
    async getData() {
      ...
      if (this.selectedNhanVien === null || this.selectedNhanVien === undefined) {
        url = `${this.apiUrl}/dieutrinoitru?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien}`;
        this.dieutrinoitru = await external_axios_default.a.get(url).then(function (response) {
        ...
        console.log("chay ok");
        url = `${this.apiUrl}/dieutrinoitru?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien.NhanVien_Id}`;
    ...
    async exportToExcel() {
      const fileName = `BV_dieutrinoitru_${this.formatDate(this.TuNgay)}_${this.formatDate(this.DenNgay)}.xlsx`;
      ...
      // Định dạng số thành "##,###"
      const numberFormat = "##,###";
      worksheet.getColumn("I").numFmt = numberFormat;
      worksheet.addRow(["STT", "Số vào viện", "Số bệnh án", "Tên bệnh nhân", "Ngày ra viện", "Số ngày điều trị", "Bác sĩ", "Bệnh án", "Thù lao"]);
      const font = {
      ...
      // Thêm dữ liệu từ this.dieutrinoitru vào tệp Excel
      this.dieutrinoitru.forEach((item, index) => {
        const ngayKhamDate = new Date(item.NgayRaVien);
        const ngayKhamFormatted = ngayKhamDate.toLocaleDateString("vi-VN", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit"
        });
        const row = worksheet.addRow([item.STT, item.SoVaoVien, item.SoBenhAn, item.TenBenhNhan, ngayKhamFormatted, item.SoNgayDieuTri, item.TenNhanVien, item.Loai, item.ThuLao]);
        row.font = font;
      });
...
// CONCATENATED MODULE: ./pages/thulao/benhvien/dieutrinoitru/index.vue?vue&type=script&lang=js
 /* harmony default export */ var benhvien_dieutrinoitruvue_type_script_lang_js = (dieutrinoitruvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(15);

// CONCATENATED MODULE: ./pages/thulao/benhvien/dieutrinoitru/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  benhvien_dieutrinoitruvue_type_script_lang_js,
  dieutrinoitruvue_type_template_id_17746a7a_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var dieutrinoitru = __webpack_exports__["default"] = (component.exports);
