...
module.exports.__inject__ = function (context) {
  add("71e6c23d", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5417a4da_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(294);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5417a4da_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5417a4da_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5417a4da_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5417a4da_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/his_pd/tonghopksk_ddketluan/index.vue?vue&type=template&id=5417a4da
...
var tonghopksk_ddketluanvue_type_template_id_5417a4da_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
  ...
  }, [_c('h2', [_vm._v("TỔNG HỢP KSK DD KẾT LUẬN")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "sm": "8",
      "md": "4"
    ...
    scopedSlots: _vm._u([{
      key: "item.thoigianhoanthanh",
      fn: function ({
        item
      }) {
        return [_vm._v("\n      " + _vm._s(new Date(item.thoigianhoanthanh).toLocaleString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit',
          hour: '2-digit',
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Number(item.bnchitra).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')) + "\n      ")];
      }
    }, {
      key: "item.thulao",
      fn: function ({
...
// CONCATENATED MODULE: ./pages/thulao/his_pd/tonghopksk_ddketluan/index.vue?vue&type=template&id=5417a4da
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/his_pd/tonghopksk_ddketluan/index.vue?vue&type=script&lang=js


/* harmony default export */ var tonghopksk_ddketluanvue_type_script_lang_js = ({
  name: 'TongHop',
  components: {},
  data: () => ({
    thuthuat: [],
  ...
  methods: {
    ...
    async getData() {
      ...
      if (this.selectedNhanVien === null || this.selectedNhanVien === undefined) {
        url = `${this.apiUrl}/get_tonghopksk_dd_ketluan_2024?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien}`;
        ...
        console.log('chay ok');
        url = `${this.apiUrl}/get_tonghopksk_dd_ketluan_2024?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien.id}`;
    ...
    async exportToExcel() {
      const fileName = `Newhis_TongHopKSK_DDKETLUAN_${this.formatDate(this.TuNgay)}_${this.formatDate(this.DenNgay)}.xlsx`;
      ...
      worksheet.addRow(['STT', 'Mã y tế', 'Tên bệnh nhân', 'Tên nhóm gói', 'Tên gói', 'Tên công ty', 'Loại hồ sơ', 'Chi nhánh', 'Chiết khấu', 'Tên dịch vụ', 'Ngày hoàn thành', 'Nhóm dịch vụ', 'Bác sĩ', 'Thù lao']);
      const font = {
      ...
      this.thuthuat.forEach(item => {
        ...
        const row = worksheet.addRow([item.stt, item.person_code, item.full_name, item.tennhomgoi, item.tengoi, item.tencongty, item.othernamemapping, item.chinhanh, item.chietkhau, item.tendichvu, NgayYeuCauFormatted, item.nhomdichvu, item.bsth, item.thulao]);
        row.font = font;
      });
...
// CONCATENATED MODULE: ./pages/thulao/his_pd/tonghopksk_ddketluan/index.vue?vue&type=script&lang=js
 /* harmony default export */ var his_pd_tonghopksk_ddketluanvue_type_script_lang_js = (tonghopksk_ddketluanvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(15);

// CONCATENATED MODULE: ./pages/thulao/his_pd/tonghopksk_ddketluan/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  his_pd_tonghopksk_ddketluanvue_type_script_lang_js,
  tonghopksk_ddketluanvue_type_template_id_5417a4da_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var tonghopksk_ddketluan = __webpack_exports__["default"] = (component.exports);
