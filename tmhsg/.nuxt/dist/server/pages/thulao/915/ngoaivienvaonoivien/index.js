...
module.exports.__inject__ = function (context) {
  add("6cb16e34", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_14f9c532_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(267);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_14f9c532_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_14f9c532_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_14f9c532_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_14f9c532_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/915/ngoaivienvaonoivien/index.vue?vue&type=template&id=14f9c532
...
var ngoaivienvaonoivienvue_type_template_id_14f9c532_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
  ...
  }, [_c('h2', [_vm._v("NGOẠI VIỆN VÀO NỘI VIỆN")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "sm": "8",
      "md": "4"
  ...
  }, [_vm._v("\n      Tổng thù lao:\n      " + _vm._s(new Number(_vm.totalThuLao).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')) + "\n    ")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Date(item.Ngay).toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        })) + "\n      ")];
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Number(item.PhiThu).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')) + "\n      ")];
      }
    }, {
      key: "item.ThuLao",
      fn: function ({
...
// CONCATENATED MODULE: ./pages/thulao/915/ngoaivienvaonoivien/index.vue?vue&type=template&id=14f9c532
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/915/ngoaivienvaonoivien/index.vue?vue&type=script&lang=js


/* harmony default export */ var ngoaivienvaonoivienvue_type_script_lang_js = ({
  name: 'TongHop',
  components: {},
  data: () => ({
    thuthuat: [],
  ...
  computed: {
    ...
    // tongThuLao() {
    //   // Đảm bảo "congkham" là một mảng hợp lệ
    //   const congkham = Array.isArray(this.congkham) ? this.congkham : [];

    //   // Tính tổng cột "ThuLao"
    //   return congkham.reduce((total, item) => {
  ...
  methods: {
    ...
    async getData() {
      ...
      if (this.selectedNhanVien === null || this.selectedNhanVien === undefined) {
        console.log('ok');
        url = `${this.apiUrl}/ngoaivienvaonoivien?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien}`;
        console.log(url);
        this.thuthuat = await external_axios_default.a.get(url).then(function (response) {
        ...
        console.log('chay ok');
        url = `${this.apiUrl}/ngoaivienvaonoivien?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien.NhanVien_Id}`;
    ...
    async exportToExcel() {
      const fileName = `915_NgoaiVienVaoNoiVien_${this.formatDate(this.TuNgay)}_${this.formatDate(this.DenNgay)}.xlsx`;
      ...
      worksheet.addRow(['STT', 'Mã y tế', 'Tên bệnh nhân', 'Công ty', 'Tên hợp đồng', 'Tên mức giảm', 'Tên dịch vụ', 'Nhóm', 'Ngày', 'Phạm vi khám', 'Tên bác sĩ', 'Thù lao']);
      const font = {
      ...
      this.thuthuat.forEach(item => {
        const ngayKhamDate = new Date(item.Ngay);
        const NgayYeuCauFormatted = ngayKhamDate.toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        });
        const row = worksheet.addRow([item.STT, item.MaYTe, item.TenBenhNhan, item.CongTy, item.TenHopDong, item.TenMucGiam, item.TenDichVu, item.Nhom, NgayYeuCauFormatted, item.PhamViKham, item.BacSi, item.ThuLao]);
        row.font = font;
      });
...
// CONCATENATED MODULE: ./pages/thulao/915/ngoaivienvaonoivien/index.vue?vue&type=script&lang=js
 /* harmony default export */ var _915_ngoaivienvaonoivienvue_type_script_lang_js = (ngoaivienvaonoivienvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(15);

// CONCATENATED MODULE: ./pages/thulao/915/ngoaivienvaonoivien/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _915_ngoaivienvaonoivienvue_type_script_lang_js,
  ngoaivienvaonoivienvue_type_template_id_14f9c532_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var ngoaivienvaonoivien = __webpack_exports__["default"] = (component.exports);
