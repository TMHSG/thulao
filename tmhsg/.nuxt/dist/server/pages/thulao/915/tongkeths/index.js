...
module.exports.__inject__ = function (context) {
  add("795ce422", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_3a11f6b9_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(272);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_3a11f6b9_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_3a11f6b9_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_3a11f6b9_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_3a11f6b9_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/915/tongkeths/index.vue?vue&type=template&id=3a11f6b9
...
var tongkethsvue_type_template_id_3a11f6b9_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
  ...
  }, [_c('h2', [_vm._v("CÔNG KHÁM KSK DK")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "sm": "8",
      "md": "4"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Date(item.NgaySinh).toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        })) + "\n      ")];
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(new Date(item.NgayKham).toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        })) + "\n      ")];
      ...
      key: "item.NgayKetHoSo",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(new Date(item.NgayKetHoSo).toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        })) + "\n      ")];
...
// CONCATENATED MODULE: ./pages/thulao/915/tongkeths/index.vue?vue&type=template&id=3a11f6b9
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/thulao/915/tongkeths/index.vue?vue&type=script&lang=js

/* harmony default export */ var tongkethsvue_type_script_lang_js = ({
  name: 'CLSKSKDK',
  components: {},
  data: () => ({
    congkham: [],
  ...
  computed: {
    ...
    tongThuLao() {
      // Tính tổng cột "ThuLao" dựa trên dữ liệu trong biến "congkham"
      return this.congkham.reduce((total, item) => {
  ...
  methods: {
    async getListNhanVien() {
      try {
        const response = await this.$axios.get(`${this.apiUrl}/nhanvien915`);
    ...
    async getData() {
      ...
      if (this.selectedNhanVien === null || this.selectedNhanVien === undefined) {
        url = `${this.apiUrl}/tongkeths915?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien}`;
        this.congkham = await this.$axios.get(url).then(function (response) {
        ...
        console.log('chay ok');
        url = `${this.apiUrl}/tongkeths915?TuNgay=${this.TuNgay}&DenNgay=${this.DenNgay}&NhanVien_Id=${this.selectedNhanVien.NhanVien_Id}`;
    ...
    async exportToExcel() {
      const fileName = `915_TongKetHS_${this.formatDate(this.TuNgay)}_${this.formatDate(this.DenNgay)}.xlsx`;
      ...
      worksheet.addRow(['STT', 'Mã y tế', 'Tên bệnh nhân', 'Ngày sinh', 'Ngày sinh', 'Ngày kết HS', 'Công ty', 'Phạm vi', 'Ngoại viện', 'Bác sĩ', 'Thù lao', 'Loại HS']);
      const font = {
      ...
      this.congkham.forEach((item, index) => {
        const ngayKhamDate = new Date(item.NgaySinh);
        const ngayKhamDate1 = new Date(item.NgayKham);
        const ngayKhamDate2 = new Date(item.NgayKetHoSo);
        const ngayKhamFormatted = ngayKhamDate.toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        });
        const ngayKhamFormatted1 = ngayKhamDate1.toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        });
        const ngayKhamFormatted2 = ngayKhamDate2.toLocaleDateString('vi-VN', {
          year: 'numeric',
          month: '2-digit',
          day: '2-digit'
        });
        const row = worksheet.addRow([item.STT, item.MaYTe, item.TenBenhNhan, ngayKhamFormatted, ngayKhamFormatted1, ngayKhamFormatted2, item.CongTy, item.PhamVi, item.NgoaiVien, item.BacSi, item.ThuLao, item.LoaiHoSo]);
        row.font = font;
      });
...
// CONCATENATED MODULE: ./pages/thulao/915/tongkeths/index.vue?vue&type=script&lang=js
 /* harmony default export */ var _915_tongkethsvue_type_script_lang_js = (tongkethsvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(15);

// CONCATENATED MODULE: ./pages/thulao/915/tongkeths/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _915_tongkethsvue_type_script_lang_js,
  tongkethsvue_type_template_id_3a11f6b9_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var tongkeths = __webpack_exports__["default"] = (component.exports);
