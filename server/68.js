...
var { conn_Clinic_PK68 } = require("./connect.js");



router.post('/uploadExcel68', upload.single('file'), async (req, res) => {
  try {
...
async function updateDatabase(data) {
  var pool = await conn_Clinic_PK68; // Khởi tạo kết nối đến cơ sở dữ liệu
  ...
  for (const row of updatedData ) {
    ...
    try {
      ...
      logContent['NhanVien_Id'] = nhanVienId; // Thêm lại cột NhanVien_Id vào logContent
...
router.get("/nhanvien68", async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get(`/thuthuat68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get(`/thuthuatbh68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoThuThuatBH_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/congkham68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get(`/congkhambh68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoCongKhamBH_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/thcls68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoThucHienCLS_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/thclsbh68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoThucHienCLSBH_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/gayme68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get(`/gaymebh68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoGayMeBH_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/cdcls68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get(`/tonghop68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;

  const { TuNgay, DenNgay, NhanVien_Id } = req.query;

  var sqlString = ` EXEC dbo.ThuLaoTongHop_2023 @TuNgay='${TuNgay}',@DenNgay='${DenNgay}',@NhanVien_Id=${NhanVien_Id}`;
...
router.get(`/tylethulao68`, async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.get("/listnhanvien68", async function (req, res) {
  var pool = await conn_Clinic_PK68;
...
router.post("/insertbacsi68", async (req, res) => {
  var pool = await conn_Clinic_PK68;
...
router.put("/updatebacsi68/:id", async (req, res) => {
  var pool = await conn_Clinic_PK68;
...
router.delete("/xoabacsi68/:id", async (req, res) => {
  var pool = await conn_Clinic_PK68;
...
router.post("/insertlog68", async (req, res) => {
  var pool = await conn_Clinic_PK68;
...
router.get("/tennhanvien68/:id", async function (req, res) {
  try {
    const pool = await conn_Clinic_PK68;
    const NhanVien_Id = req.params.id;
